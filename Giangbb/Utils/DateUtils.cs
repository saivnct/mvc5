...
namespace Giangbb.Utils
{
    ...
    public class DateUtils
    {
        ...
        public const string FORMAT_BIRTHDAY = "dd/MM/yyyy";
        ...
        private static long GetTimeMilisecond(DateTime date)
        {            
        ...
        public static long GetDiffMilis(DateTime date1, DateTime date2)
        {
            return Math.Abs(GetTimeMilisecond(date1) - GetTimeMilisecond(date2));
        }

        public static long GetDiffSeconds(DateTime date1, DateTime date2)
        {
            long diff = GetDiffMilis(date1, date2) / 1000;
            return diff;
        }

        public static long GetDiffMinutes(DateTime date1, DateTime date2)
        {
            long diff = GetDiffMilis(date1, date2) / (60*1000);
            return diff;
        }

        public static long GetDiffHours(DateTime date1, DateTime date2)
        {
            long diff = GetDiffMilis(date1, date2) / (60 *60 * 1000);
            return diff;
        }

        public static long GetDiffDays(DateTime date1, DateTime date2)
        {
            long diff = GetDiffMilis(date1, date2) / (24* 60 * 60 * 1000);
            return diff;
        }

        public static long GetDiffYear(DateTime date1, DateTime date2)
        {
        ...
        public static string GetDateStringByFormat(DateTime date,string dateFormat)
        {
            return date.ToString(dateFormat);
        }       

        public static string GetDateStringByFormat(long date, string dateFormat)
        {
            return LongToDateTime(date).ToString(dateFormat);
        }

        public static DateTime GetDateFromString(string dateStr, string dateFormat)
        {
           return DateTime.ParseExact(dateStr, dateFormat,
